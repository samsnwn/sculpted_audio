...
const Hero = () => {
  ...
  return (
    <section className="w-full min-h-screen flex items-center m-auto relative">
      ...
      <SectionWrapper>
        ...
        <div 
        className="absolute left-1/2 transform -translate-x-1/2 translate-y-80 transition-opacity duration-300 ease-in-out"
