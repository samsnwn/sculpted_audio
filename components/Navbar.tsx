...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Hamburger Menu */}
      <div
        className={`flex flex-col fixed h-screen ease-in-out duration-300 top-0 w-[65%] items-center justify-center gap-32 pb-28 text-center rounded-md shadow shadow-red ${
